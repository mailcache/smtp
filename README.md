MailCache SMTP Protocol [![GoDoc](https://godoc.org/github.com/mailcache/smtp?status.svg)](https://godoc.org/github.com/mailcache/smtp) [![Build Status](https://travis-ci.org/mailcache/smtp.svg?branch=master)](https://travis-ci.org/mailcache/smtp)
=========

`github.com/mailcache/smtp` implements an SMTP server state machine.
...
See [MailCache-Server](https://github.com/mailcache/mailcache-server) and [MailCache-MTA](https://github.com/mailcache/mailcache-mta) for example implementations.
...
See [![GoDoc](https://godoc.org/github.com/mailcache/smtp?status.svg)](https://godoc.org/github.com/mailcache/smtp) for more information.
